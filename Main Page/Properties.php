...
<body>
    ...
    <aside>
        <nav>
            ...
            <a href="Properties.php" class="block py-2 px-4 bg-gray-700 rounded mb-2 text-white">Properties</a>
            <a href="ContactUs.php" class="block py-2 px-4 hover:bg-gray-700 rounded hover:text-white">Contact Us</a>
        </nav>
    </aside>
